...
from test_generation.ga.random  import GA
...
if __name__ == '__main__':
    ...
    rlaga = GA(pop_size, generations, mutation_rate, env, scenario_topic,  result_save_path='/home/linfeng/Documents/random_lawn')
