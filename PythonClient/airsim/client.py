...
#image_type uses one of the ImageType members
    ...
    def simGetNPCVehicleSpeed(self, object_name):
        speed = self.client.call('simGetNPCVehicleSpeed', object_name)
        return speed


    def simSetNPCVehicleThrottle(self, object_name, throttle):
        success = self.client.call('simSetNPCVehicleThrottle', object_name, throttle)
        return success

    def simSetNPCVehicleSteering(self, object_name, steering):
        success = self.client.call('simSetNPCVehicleSteering', object_name, steering)
        return success

    def simSetNPCSpeed(self, object_name, speed):
        success = self.client.call('simSetNPCSpeed', object_name, speed)
        return success


    def simSetNPCMoveTo(self, object_name, pose):
        success = self.client.call('simSetNPCMoveTo', object_name, pose)
        return success
