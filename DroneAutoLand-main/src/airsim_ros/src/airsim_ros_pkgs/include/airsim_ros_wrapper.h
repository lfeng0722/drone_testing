...
private:
    ...
    std::vector<ros::Publisher> cam_pose_global_pub_vec_;


    std::vector<sensor_msgs::CameraInfo> camera_info_msg_vec_;
    std::vector<geometry_msgs::PoseStamped> camera_pose_msg_vec_;
    std::vector<geometry_msgs::PoseStamped> camera_pose_global_msg_vec_;
