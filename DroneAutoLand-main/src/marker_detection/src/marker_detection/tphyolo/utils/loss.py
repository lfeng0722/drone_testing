...
class ComputeLoss:
    ...
    def build_targets(self, p, targets):
        ...
        gain = torch.ones(7, dtype=torch.int64, device=targets.device)  # normalized to gridspace gain
        ...
        for i in range(self.nl):
            ...
            #print('in loss.py, line 238, gi.type={}, gi.shape={}, gi.dtype={}'.format(gi, gi.shape, gi.dtype))
            # Append
